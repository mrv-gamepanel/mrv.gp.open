		...
		<div class="page-content">
			<div class="page-header">
				<div class="container-fluid">
					<h2 class="h5 no-margin-bottom">Mods</h2>
				</div>
			</div>
							...
							<div class="col-lg-12">
								<div class="block">
									<table id="serverList" class="table table-striped table-sm">
										...
										<tbody>
											<?php foreach ($Mods->modsList()['Response'] as $k => $v) { ?>
                                                <tr id="tr-id-<?php echo $v['id']; ?>" class="tr-class-<?php echo $v['id']; ?>" data-title="bootstrap table" data-object='{"key": "value"}' onclick="document.location.href = '/<?php echo $admDir; ?>/mod?id=<?php echo $v['id']; ?>'" style="cursor:pointer;">
                                                    <td><a href="/<?php echo $admDir; ?>/mod?id=<?php echo $v['id']; ?>"><?php echo $Secure->SecureTxt($v['Name']); ?></a></td>
                                                    <td><?php echo $Secure->SecureTxt($Games->gameByID($v['gameID'])['Name']); ?></td>
                                                    <td><?php echo $Secure->SecureTxt($v['Note']); ?></td>
			                                    </tr>
											<?php } ?>
										</tbody>
									</table>
