		...
		<div class="page-content">
			<div class="page-header">
				<div class="container-fluid">
					<h2 class="h5 no-margin-bottom">Add Game</h2>
				</div>
			</div>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12">
                            ...
                            <form class="form-horizontal" method="POST" autocomplete="off" action="/admin/process?addGame">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" name="gameSmName" class="form-control" required="">
									</div>
								</div> <div class="line"></div>
								<div class="form-group row">
									<label class="col-sm-3 form-control-label">Icon</label>
									<div class="col-sm-9">
										<input type="text" name="gameIcon" class="form-control" required="">
									</div>
								</div> <div class="line"></div>
								<div class="form-group row">
									<label class="col-sm-3 form-control-label">Avatar</label>
									<div class="col-sm-9">
										<input type="text" name="gameAvatar" class="form-control" required="">
									</div>
								</div> <div class="line"></div>
								<div class="form-group row">
