		...
		<div class="page-content">
			<div class="page-header">
				<div class="container-fluid">
					<h2 class="h5 no-margin-bottom">Add Plugin
                    </h2>
				</div>
			</div>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12">
                            ...
                            <form class="form-horizontal" method="POST" autocomplete="off" action="/admin/process?addPlugin">
								<div class="form-group row">
									<label class="col-sm-3 form-control-label">Name</label>
									<div class="col-sm-9">
										<input type="text" name="pluginName" class="form-control" required="">
									</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" name="pluginDir" class="form-control" required="">
									</div>
								</div> <div class="line"></div>
								<div class="form-group row">
