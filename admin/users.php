								...
								<div class="block">
									<table id="UserList" class="table table-striped table-sm">
										...
										<tbody>
											...
											<tr>
												<th><a href="user?id=<?php echo $b_v['id'] ?>"><?php echo $Secure->SecureTxt($b_v['Username']); ?></a></th>
												<th><?php echo $Secure->SecureTxt($b_v['Email']); ?></th>
												<th><?php echo $Secure->SecureTxt($b_v['Name'].' '.$b_v['Lastname']); ?></th>
												<th><?php if($b_v['Status'] == 0) { echo 'Neaktivan'; } else { echo 'Aktivan'; } ?></th>
											</tr>
											<?php } ?>
										</tbody>
									</table>
